...
with left:
    ...
    # Keep three boxes regardless of the actual number of results.
    for i in range(3):
...
with right:
    ...
    # Keep the original risk assessment panel,
    # but hide all information inside it for DA1.
    st.markdown("""
    ...
    # ── DISTRICT SUMMARY ───────────────────────────────────────────
    # THIS SECTION IS FULLY PRESERVED.
